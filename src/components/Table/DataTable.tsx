  ...
  return (
    <div ref={tableRef}>
      <Table
        ...
        className="pos-table rounded-lg overflow-hidden border border-primary/30 bg-white/40 backdrop-blur-md shadow-card transition-shadow duration-300 hover:shadow-card-hover"
